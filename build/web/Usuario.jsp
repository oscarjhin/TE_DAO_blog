...
<html>
    ...
    <body>
        ...
        <p><a href="ControladorUsuario?action=add" class="btn"><img src="Imagenes/nuevo.png" title="Nuevo registro"/>Nuevo</a></p>
        <div class="datagrid">  
            <table border="1">
                <thead>
                <tr>
                ...
                <c:forEach var="item" items="${lista_obj}">        
                    <tr>
                        ...
                        <th><a href="ControladorUsuario?action=edit&id=${item.ci}"><img src="Imagenes/editar.png" title="Modificar"/></a></th>
                        <td><a href="ControladorUsuario?action=delete&id=${item.ci}" onclick="return(confirm('Esta seguro de eliminar??'))"><img src="Imagenes/delete.png" title="Eliminar"/></a></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
